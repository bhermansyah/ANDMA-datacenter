...
function init_leaflet(){
	...
	if ($('#leaflet_access_map').length ){
	    ...
	    {
	        "nAirprt" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	                    layers: 'geonode:afg_capa_airdrm',
	                    format: 'image/png',
	                    transparent: true
	        }),
	        "nHlt1" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	                    layers: 'geonode:afg_capa_hltfac_tier1',
	                    format: 'image/png',
	                    transparent: true
	        }),
	        "nHlt2" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	                    layers: 'geonode:afg_capa_hltfac_tier2',
	                    format: 'image/png',
	                    transparent: true
	        }),
	        "nHlt3" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	                    layers: 'geonode:afg_capa_hltfac_tier3',
	                    format: 'image/png',
	                    transparent: true
	        }),
	        "nHltAll" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	                    layers: 'geonode:afg_capa_hltfac_tierall',
	                    format: 'image/png',
	                    transparent: true
	        }),
	        "nItProvCap" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	                    layers: 'geonode:afg_capa_adm1_its_provc',
	                    format: 'image/png',
	                    transparent: true
	        }),
	        "nProvCap" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	                    layers: 'geonode:afg_capa_adm1_nearest_provc',
	                    format: 'image/png',
	                    transparent: true
	        }),
	        "nDistCntr" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	                    layers: 'geonode:afg_capa_adm2_nearest_districtc',
	                    format: 'image/png',
	                    transparent: true
	        }),

	        "Provincial Boundary" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	...
	if ($('#leaflet_fforecast_map').length ){
...

	    {
	        ...
	        "fforecast" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	...
	if ($('#leaflet_floodrisk_map').length ){
		...
		{
		    "frisk" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	...
	if ($('#leaflet_aforecast_map').length ){
	    ...
	    {
	        "aforecast" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	...
	if ($('#leaflet_avarisk_map').length ){
	    ...
	    {
	        "arisk" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	...
	if ($('#leaflet_lndslide_map').length ){
	    ...
	    {
	    	"ku" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	    			    layers: 'geonode:afg_ls_500m_ku_lsi',
	    			    format: 'image/png',
	    			    transparent: true
	    	}),
	    	"s1" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	    			    layers: 'geonode:afg_ls_30m_wb_s1',
	    			    format: 'image/png',
	    			    transparent: true
	    	}),
	    	"s2" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	    			    layers: 'geonode:afg_ls_30m_wb_s2',
	    			    format: 'image/png',
	    			    transparent: true
	    	}),
	    	"s3" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	    			    layers: 'geonode:afg_ls_30m_wb_s3',
	    			    format: 'image/png',
	    			    transparent: true
	    	})
	    	// ,
	     //    "provincial_boundary" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	     //                layers: 'geonode:afg_admbnda_adm1',
	     //                format: 'image/png',
	     //                transparent: true
	     //    })
	...
	if ($('#leaflet_drought_map').length ){
	    ...
	    {
	        "landcover" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	                    layers: 'geonode:afg_lndcrva',
	                    format: 'image/png',
	                    styles: 'afg_lndcrva_main',
	                    transparent: true
	        }),
	        "drought" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
	...
	if ($('#leaflet_erthqk_map').length ){
	    ...
	    var wmsLayer = 
	    {
	        ...
	        "erthqk" : L.tileLayer.wms('http://anhdc.andma.gov.af/geoserver/wms?', {
