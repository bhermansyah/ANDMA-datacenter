...
THEME_ACCOUNT_CONTACT_EMAIL = 'anhdc@andma.gov.af'
...
# authentication.
AUTH_EXEMPT_URLS = (r'^/?$','/api','/getOverviewMaps','/account/signup','/geoapi', '/dashboard/print', '/about', '/disclaimer', '/partners', '/video', '/training', '/dashboard/classmarker_insert', '/v2/dashboard/print', '/uploaded/logos', '/documents/api','/i18n/setlang/')
