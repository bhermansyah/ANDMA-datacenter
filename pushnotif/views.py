...
def init_globaldata(request=None):
    ...
    eventtypedata = {
        ...
        #     # 'createjsondata': r'{"units":"m","srs":"EPSG:900913","layout":"A4 portrait","dpi":90,"outputFilename":"\"iMMAP_AFG_River and flash flood forecast_A4 portrait_map_2017-9-11\"","mapTitle":"River and flash flood prediction","comment":"Gives forecast on river floods and flash floods. River flood predictions are valid for 4 days and updated every 6 hours, whereas the flash floods are valid for 6 hours and updated hourly. \nThe map and statistics are is updated every 6 hours.","layers":[{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":0,"singleTile":false,"type":"WMS","layers":["geonode:afg_ppla"],"format":"image/png8","styles":["polygon_nothing"],"customParams":{"TRANSPARENT":true}},{"minScaleDenominator":0.520684892112729,"maxScaleDenominator":559081145.7863648,"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_airdrmp"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"minScaleDenominator":0.520684892112729,"maxScaleDenominator":559081145.7863648,"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_fldzonea_100k_risk_landcover_pop"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"minScaleDenominator":1066.3626590468689,"maxScaleDenominator":559081145.7863648,"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:current_flood_forecasted_villages_basin"],"format":"image/png8","styles":["current_flood_forecasted_villages_basin"],"customParams":{"TRANSPARENT":true,"TILED":false}},{"minScaleDenominator":1066.3626590468689,"maxScaleDenominator":559081145.7863648,"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:glofas_gfms_merge"],"format":"image/png","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":false,"VIEWPARAMS":"year:2017;month:09;day:06;"}},{"minScaleDenominator":0.520684892112729,"maxScaleDenominator":559081145.7863648,"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_riv"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"minScaleDenominator":0.520684892112729,"maxScaleDenominator":559081145.7863648,"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_admbnda_adm2"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"minScaleDenominator":0.520684892112729,"maxScaleDenominator":559081145.7863648,"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_admbnda_adm1"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"minScaleDenominator":0.520684892112729,"maxScaleDenominator":559081145.7863648,"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_pplp"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}}],"pages":[{"center":[7344740.0101932,3870141.1300305],"scale":1500000,"bbox":[7196573.0471926,3735203.360155,7492906.9731938,4005078.899906],"rotation":0}],"legends":[{"name":"Settlements","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_pplp&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Provincial boundaries","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_admbnda_adm1&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"District boundaries","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_admbnda_adm2&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Rivers","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_riv&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Classes of ","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aglofas_gfms_merge&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Population affected by  settlements","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Acurrent_flood_forecasted_villages_basin&style=current_flood_forecasted_villages_basin&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Flood risk zones (100 year interval)","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_fldzonea_100k_risk_landcover_pop&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Airports/Airfields","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_airdrmp&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]}],"selectedBox":"64.64791562475617,31.785625036334896%2067.30992857442693,31.785625036334896%2067.30992857442693,33.82314149783689%2064.64791562475617,33.82314149783689%2064.64791562475617,31.785625036334896","showRiskTable":false,"mapID":"700"}',
        #     'createjsonfile': 'create_flashflood.json',
        #     'url_getmap_tpl': 'http://18.196.236.51/getOverviewMaps/getWMS?service=WMS&version=1.1.0&request=GetMap&layers={layers}&styles=,snapshot_admin1&VIEWPARAMS=year:{year};month:{month};day:{day};&bbox={bbox}&width={width}&height={height}&srs=EPSG:4326&format=image%2Fpng&_rdm=202',
        ...
        'avalanche_prediction':
        {
            ...
            # 'createjsondata': r'{"units":"m","srs":"EPSG:900913","layout":"A4 portrait","dpi":90,"outputFilename":"\"iMMAP_AFG_Avalanche prediction / current risk_A4 portrait_map_2017-9-29\"","mapTitle":"Avalanche prediction / current risk","comment":"Shows the number of people potentially affected by avalanches based on the current snow cover and snow water equivalent (at small basin scale)","layers":[{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":0,"singleTile":false,"type":"WMS","layers":["geonode:afg_ppla"],"format":"image/png8","styles":["polygon_nothing"],"customParams":{"TRANSPARENT":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_elev_dem_30m_aster_hillshade"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:current_avalanche_forecast_villages"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_admbnda_adm1"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_admbnda_adm2"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_avsa"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_pplp"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}}],"pages":[{"center":[7713827.67075,4328013.9672],"scale":25000,"bbox":[7711358.2213667,4325765.0043687,7716297.1201333,4330262.9300313],"rotation":0}],"legends":[{"name":"Settlements","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_pplp&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=25000"]}]},{"name":"Avalanche areas (potential)","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_avsa&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=25000"]}]},{"name":"District boundaries","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_admbnda_adm2&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=25000"]}]},{"name":"Provincial boundaries","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_admbnda_adm1&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=25000"]}]},{"name":"Avalanche risk forecast settlements","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Acurrent_avalanche_forecast_villages&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=25000"]}]}],"selectedBox":"69.27230952538713,36.1825200849458%2069.31667640788086,36.1825200849458%2069.31667640788086,36.215126252405994%2069.27230952538713,36.215126252405994%2069.27230952538713,36.1825200849458","showRiskTable":false,"mapID":"707"}',
        ...
        'earthquake_shakemap':
        {
            ...
            # 'createjsondata': '{"units":"m","srs":"EPSG:900913","layout":"A4 portrait","dpi":90,"outputFilename":"\\"iMMAP_AFG_Earthquake_A4 portrait_map_2017-9-29\\"","mapTitle":"Earthquake","comment":"Shows the epicentre of the latest earthquakes as well as the shakemap. Shakemaps and the affected population can be loaded by using the latest tab in the statistics menu.\\n\\nAdditionally it shows the tectonic regions of Afghanistan derived from the USGS \\"Seismotectonic Map of Afghanistan, with Annotated Bibliography\\" (2005) by By Russell L. Wheeler, Charles G. Bufe, Margo L. Johnson, and Richard L. Dart. \\n\\nSeismic intensity and description of potential damage (USGS, 2007). Peak Horizontal Acceleration with 2 Percent Probability of Exceedance in 50 years\\n\\nA 2 percent probability of exceedance in 50 years corresponds to a ground-motion return time of approximately 2500 years, or approximately a 10% probability of of exceedance in 250 years. . The seismic intensity data and classes originate from the USGS Earthquake Hazard Map for Afghanistan (2007), by By Oliver S. Boyd, Charles S. Mueller, and Kenneth S. Rukstales","layers":[{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":0,"singleTile":false,"type":"WMS","layers":["geonode:afg_ppla"],"format":"image/png8","styles":["polygon_nothing"],"customParams":{"TRANSPARENT":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_elev_dem_30m_aster_hillshade"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_riv"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_admbnda_adm1"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_admbnda_adm2"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_riv"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"minScaleDenominator":25253.763106179995,"maxScaleDenominator":631344077654500,"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_rdsl"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:earthquake_shakemap"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"CQL_FILTER":"event_code=\'$event_code\'","TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_pplp"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:earthquake_events"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"CQL_FILTER":"event_code in (\'$event_code\')","TILED":true}}],"pages":[{"center":[8147575.7178394,4429009.4558803],"scale":1500000,"bbox":[8147081.8279627,4428559.663314,8148069.6077161,4429459.2484466],"rotation":0}],"legends":[{"name":"Earthquakes with Shakemap ","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aearthquake_events&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Settlements","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_pplp&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Earthquake shakemap","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aearthquake_shakemap&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000"]}]},{"name":"Road network","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?EXCEPTIONS=application%2Fvnd.ogc.se_xml&TRANSPARENT=TRUE&SERVICE=WMS&VERSION=1.1.1&REQUEST=GetLegendGraphic&TILED=true&LAYER=geonode%3Aafg_rdsl&STYLE=afg_rdsl_legend_osm&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000&width=12&height=12"]}]},{"name":"Rivers","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_riv&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000"]}]},{"name":"District boundaries","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_admbnda_adm2&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000"]}]},{"name":"Provincial boundaries","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_admbnda_adm1&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000"]}]},{"name":"Rivers","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_riv&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]}],"selectedBox":"73.18648128050067,36.92429450170914%2073.19535465700014,36.92429450170914%2073.19535465700014,36.930754510341295%2073.18648128050067,36.930754510341295%2073.18648128050067,36.92429450170914","showRiskTable":false,"mapID":"706"}',
            'createjsonfile': 'create_earthquake.json',
            'url_getmap_tpl': 'http://18.196.236.51/getOverviewMaps/getWMS?service=WMS&version=1.1.0&request=GetMap&layers={layers}&styles=&CQL_FILTER=event_code%3D%27{eqcode}%27;event_code%3D%27{eqcode}%27;INCLUDE&bbox={bbox}&width={width}&height={height}&srs=EPSG:4326&format=image%2Fpng',
        ...
        'earthquake_epicenter':
        {
            ...
            'dashboardpage': 'earthquake',
            'maplayers': 'geonode:earthquake_events,geonode:earthquake_shakemap,afg_admbnda_adm1',
            # 'createjsondata': '{"units":"m","srs":"EPSG:900913","layout":"A4 portrait","dpi":90,"outputFilename":"\\"iMMAP_AFG_Earthquake_A4 portrait_map_2017-9-29\\"","mapTitle":"Earthquake","comment":"Shows the epicentre of the latest earthquakes as well as the shakemap. Shakemaps and the affected population can be loaded by using the latest tab in the statistics menu.\\n\\nAdditionally it shows the tectonic regions of Afghanistan derived from the USGS \\"Seismotectonic Map of Afghanistan, with Annotated Bibliography\\" (2005) by By Russell L. Wheeler, Charles G. Bufe, Margo L. Johnson, and Richard L. Dart. \\n\\nSeismic intensity and description of potential damage (USGS, 2007). Peak Horizontal Acceleration with 2 Percent Probability of Exceedance in 50 years\\n\\nA 2 percent probability of exceedance in 50 years corresponds to a ground-motion return time of approximately 2500 years, or approximately a 10% probability of of exceedance in 250 years. . The seismic intensity data and classes originate from the USGS Earthquake Hazard Map for Afghanistan (2007), by By Oliver S. Boyd, Charles S. Mueller, and Kenneth S. Rukstales","layers":[{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":0,"singleTile":false,"type":"WMS","layers":["geonode:afg_ppla"],"format":"image/png8","styles":["polygon_nothing"],"customParams":{"TRANSPARENT":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_elev_dem_30m_aster_hillshade"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_riv"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_admbnda_adm1"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_admbnda_adm2"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_riv"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"minScaleDenominator":25253.763106179995,"maxScaleDenominator":631344077654500,"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_rdsl"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:earthquake_shakemap"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"CQL_FILTER":"event_code=\'$event_code\'","TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_pplp"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:earthquake_events"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"CQL_FILTER":"event_code in (\'$event_code\')","TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:earthquake_events_past_week"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}}],"pages":[{"center":[8147575.7178394,4429009.4558803],"scale":1500000,"bbox":[8147081.8279627,4428559.663314,8148069.6077161,4429459.2484466],"rotation":0}],"legends":[{"name":"Earthquakes in the past week","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aearthquake_events_past_week&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Earthquakes with Shakemap ","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aearthquake_events&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Settlements","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_pplp&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Earthquake shakemap","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aearthquake_shakemap&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000"]}]},{"name":"Road network","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?EXCEPTIONS=application%2Fvnd.ogc.se_xml&TRANSPARENT=TRUE&SERVICE=WMS&VERSION=1.1.1&REQUEST=GetLegendGraphic&TILED=true&LAYER=geonode%3Aafg_rdsl&STYLE=afg_rdsl_legend_osm&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000&width=12&height=12"]}]},{"name":"Rivers","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_riv&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000"]}]},{"name":"District boundaries","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_admbnda_adm2&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000"]}]},{"name":"Provincial boundaries","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_admbnda_adm1&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000"]}]},{"name":"Rivers","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_riv&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]}],"selectedBox":"73.18648128050067,36.92429450170914%2073.19535465700014,36.92429450170914%2073.19535465700014,36.930754510341295%2073.18648128050067,36.930754510341295%2073.18648128050067,36.92429450170914","showRiskTable":false,"mapID":"706"}',
            'createjsonfile': 'create_earthquake.json',
            'url_getmap_tpl': 'http://18.196.236.51/getOverviewMaps/getWMS?service=WMS&version=1.1.0&request=GetMap&layers={layers}&styles=&CQL_FILTER=event_code%3D%27{eqcode}%27;event_code%3D%27{eqcode}%27;INCLUDE&bbox={bbox}&width={width}&height={height}&srs=EPSG:4326&format=image%2Fpng',
            'view_interactive_map_url': settings.SITEURL+'/maps/706/view',
            'mappdf': {
...
def triggercheck(request):
    ...
    def get_earthquakes_list(date_limit, bbox):
        url = 'http://18.196.236.51/geoapi/geteqevents/?dateofevent__gte=%s&_dc=1473243793279' % (date_limit)
        # url = 'http://18.196.236.51/geoapi/geteqevents/?dateofevent=2016-04-10&_dc=1473243793279'
    ...
    '''
        ...
        #     emaildata['createjsondata'] = '{"units":"m","srs":"EPSG:900913","layout":"A4 portrait","dpi":90,"outputFilename":"\\"iMMAP_AFG_Earthquake_A4 portrait_map_2017-9-29\\"","mapTitle":"Earthquake","comment":"Shows the epicentre of the latest earthquakes as well as the shakemap. Shakemaps and the affected population can be loaded by using the latest tab in the statistics menu.\\n\\nAdditionally it shows the tectonic regions of Afghanistan derived from the USGS \\"Seismotectonic Map of Afghanistan, with Annotated Bibliography\\" (2005) by By Russell L. Wheeler, Charles G. Bufe, Margo L. Johnson, and Richard L. Dart. \\n\\nSeismic intensity and description of potential damage (USGS, 2007). Peak Horizontal Acceleration with 2 Percent Probability of Exceedance in 50 years\\n\\nA 2 percent probability of exceedance in 50 years corresponds to a ground-motion return time of approximately 2500 years, or approximately a 10% probability of of exceedance in 250 years. . The seismic intensity data and classes originate from the USGS Earthquake Hazard Map for Afghanistan (2007), by By Oliver S. Boyd, Charles S. Mueller, and Kenneth S. Rukstales","layers":[{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":0,"singleTile":false,"type":"WMS","layers":["geonode:afg_ppla"],"format":"image/png8","styles":["polygon_nothing"],"customParams":{"TRANSPARENT":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_elev_dem_30m_aster_hillshade"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_riv"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_admbnda_adm1"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_admbnda_adm2"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_riv"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"minScaleDenominator":25253.763106179995,"maxScaleDenominator":631344077654500,"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_rdsl"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:earthquake_shakemap"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"CQL_FILTER":"event_code=\'10008rah\'","TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:afg_pplp"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:earthquake_events"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"CQL_FILTER":"event_code in (\'10003qv5\',\'100042n2\',\'10003re5\',\'10003yzt\',\'100040ct\',\'100044k6\',\'100044km\',\'100044lp\',\'100049i1\',\'10004dtm\',\'10004rhs\',\'20005gsg\',\'10005h1j\',\'200066x9\',\'200067p3\')","TILED":true}},{"baseURL":"http://18.196.236.51/geoserver/wms","opacity":1,"singleTile":false,"type":"WMS","layers":["geonode:earthquake_events_past_week"],"format":"image/png8","styles":[""],"customParams":{"TRANSPARENT":true,"TILED":true}}],"pages":[{"center":[8147575.7178394,4429009.4558803],"scale":1500000,"bbox":[8147081.8279627,4428559.663314,8148069.6077161,4429459.2484466],"rotation":0}],"legends":[{"name":"Earthquakes in the past week","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aearthquake_events_past_week&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Earthquakes with Shakemap ","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aearthquake_events&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Settlements","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_pplp&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]},{"name":"Earthquake shakemap","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aearthquake_shakemap&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000"]}]},{"name":"Road network","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?EXCEPTIONS=application%2Fvnd.ogc.se_xml&TRANSPARENT=TRUE&SERVICE=WMS&VERSION=1.1.1&REQUEST=GetLegendGraphic&TILED=true&LAYER=geonode%3Aafg_rdsl&STYLE=afg_rdsl_legend_osm&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000&width=12&height=12"]}]},{"name":"Rivers","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_riv&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000"]}]},{"name":"District boundaries","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_admbnda_adm2&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000"]}]},{"name":"Provincial boundaries","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_admbnda_adm1&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=5000"]}]},{"name":"Rivers","classes":[{"name":"","icons":["http://18.196.236.51/geoserver/wms?request=GetLegendGraphic&width=12&height=12&layer=geonode%3Aafg_riv&transparent=true&format=image%2Fpng&Language=en&legend_options=fontSize%3A5%3Bdpi%3A300&SCALE=1500000"]}]}],"selectedBox":"73.18648128050067,36.92429450170914%2073.19535465700014,36.92429450170914%2073.19535465700014,36.930754510341295%2073.18648128050067,36.930754510341295%2073.18648128050067,36.92429450170914","showRiskTable":false,"mapID":"706"}'
        #     emaildata['recipients'] = []
        #     emailid = script_start_time+key_separator+emaildata['eventtype'].lower().strip().replace(" ", "_")+key_separator+(emaildata['area_scope']+sub_key_separator+emaildata['area_name']).lower().strip().replace(" ", "_")
        #
        #     if sendlimitcheck(emailid):
...
def sendnotif_dashboard(emaildata={}):
    ...
    pdf2_url = session2.post('http://18.196.236.51/geoserver/pdf/create.json', data=data_pdf2_str)
    ...
    response = session2.post('http://18.196.236.51/dashboard/multiple', data=multiple_url)

    # get combined pdf
    combined_pdf_name = json.loads(response.content)['filename']
    tpl = Template('http://18.196.236.51/dashboard/downloadPDFFile?filename=$filename&filenameoutput=$filenameoutput')
    url = tpl.substitute(
...
def get_pdf(emaildata={}):
    ...
    # pdf2_url = session2.post('http://18.196.236.51/geoserver/pdf/create.json', data=data_pdf2_str)
    url = 'http://18.196.236.51/geoserver/pdf/create.json'
    ...
    try:
        ...
        if pdf2_url.status_code != 200:
            ...
            url = 'http://18.196.236.51/dashboard/multiple'
            cacheid = 'get:'+url+':'+emaildata['emailid']
            if 'cacheid' in debuglist: log.debug(' '.join(map(str, ['cacheid:', cacheid])))
            try:
